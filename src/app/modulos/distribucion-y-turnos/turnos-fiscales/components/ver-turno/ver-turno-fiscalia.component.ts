    ...
    this.infoMessage = [
      {
        severity: 'warn',
        detail:
          'Nota: Tener en cuenta solo se permite registrar el turno fiscal desde la fecha actual o una fecha futura (no se pueden registrar turno con fechas ya pasadas o anteriores).',
      },
    ];
  }
