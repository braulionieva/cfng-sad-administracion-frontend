...
@Component({
  selector: 'app-alert-modal-masivo-usuario',
  standalone: true,
  imports: [CommonModule, ButtonModule, TableModule, TagModule],
  templateUrl: './alert-modal-masivo-usuario.component.html',
  styleUrls: ['./alert-modal-masivo-usuario.component.scss'],
})
export class AlertModalMasivoUsuarioComponent {
  ...
  constructor(
    ...
    console.log("this.config.data?.noRegistrados",this.config.data)
  }
